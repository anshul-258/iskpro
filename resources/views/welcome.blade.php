                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="single-blog">
                        <div class="blog-photo">
                            @if($b->image)
                            <img src="{{PREFIX}}uploads/blog/{{$b->image}}" alt="">
                            @else
                        ...
                        <div class="blog-content">
                            ...
                            <ul class="blog-meta">
                                ...
                                <li><span class="ti-calendar"></span> <a href="#">{{date('M d,Y',strtotime($b->created_at))}}</a></li>
                            </ul>
                            <p>{!! substr($b->content,0,70) !!}</p>
                        </div>
                    </div>
                </div>
                @endforeach
