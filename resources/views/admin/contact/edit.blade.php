                ...
                <div class="panel-body">
                   <div class="modal-body mx-3">
				        <div class="md-form mb-5">
				          ...
				          <input type="text" id="defaultForm-email" class="form-control validate" name="title" value="{{$blog->title}}">
				         
				        </div>

				        <div class="md-form mb-4">
				           <label data-error="wrong" data-success="right" for="editor">Content</label>
				          <textarea  id="editor" class="form-control validate" name="content" style="height: 200px;">{{$blog->content}}</textarea>
