        ...
        if ($t1 != '.' && $t1 != '..') {
            ...
            if (is_dir($d1)) {
                ...
                if (in_array(strtolower(pathinfo($d1, PATHINFO_EXTENSION)), $allowedext)) {
                    ...
                    $arrfile[] = array('url' => str_replace('/var/www/html/admin/public/uploads/blog/', 'http://localhost/admin/public/uploads/blog/', $d1), 'width' => isset($iinfo[0]) ? $iinfo[0] : '', 'height' => isset($iinfo[1]) ? $iinfo[1] : '');
                }
            }
        }
    }
...
$base_path =  '/var/www/html/admin/public/uploads/blog/';
